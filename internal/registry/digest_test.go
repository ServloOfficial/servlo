...
func TestManifestDigest_GHCRTokenFlow(t *testing.T) {
	...
	got, err := ManifestDigest("ghcr.io/servloofficial/servlo-php84-fpm-base:abc123")
	if err != nil {
	...
	if _, err := ManifestDigest("ghcr.io/servloofficial/servlo-php84-fpm-base:abc123"); err != nil {
	...
	if err := InvalidateManifestDigest("ghcr.io/servloofficial/servlo-php84-fpm-base:abc123"); err != nil {
...
func TestManifestDigest_NotFound(t *testing.T) {
	...
	if _, err := ManifestDigest("ghcr.io/servloofficial/servlo-php84-fpm-base:gone"); err == nil {
