...
func TestParseAccessHost(t *testing.T) {
	cases := []struct {
		...
		{"pipe timing record", "<190>Jun 12 10:00:00 servloaccess: myapp.test|200|0.042|GET|/reports/5", "myapp.test"},
		{"pipe record dash host", "<190>Jun 12 10:00:00 servloaccess: -|400|0.001|GET|/", ""},
		{"syslog framed", "<190>Jun 12 10:00:00 servloaccess: myapp.test", "myapp.test"},
		{"trailing newline", "myapp.test\n", "myapp.test"},
		{"no host header dash", "<190>Jun 12 10:00:00 servloaccess: -", ""},
		{"empty", "", ""},
		{"whitespace only", "   \n", ""},
	}
