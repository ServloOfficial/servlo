  ...
  <div class="px-5 py-4 space-y-3">
    ...
    <div class="space-y-2">
      <input
        ...
        autocomplete="off"
        class="w-full text-sm bg-gray-50 dark:bg-servlo-bg border border-gray-200 dark:border-servlo-border rounded-sm px-2.5 py-1.5 text-gray-700 dark:text-gray-300 placeholder-gray-400 focus:outline-hidden focus:border-servlo-red/50"
      />
      <input
        type="password"
        bind:value={password}
