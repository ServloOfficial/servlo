...
{#if visible}
  <div class="relative rounded-xl bg-linear-to-br from-servlo-red/10 via-servlo-red/5 to-transparent dark:from-servlo-red/15 dark:via-servlo-red/5 border border-servlo-red/20 dark:border-servlo-red/30 px-5 py-5 sm:py-6">
    <button
      type="button"
      onclick={dismiss}
    ...
    <div class="mt-5 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
      <div class="rounded-lg bg-white/70 dark:bg-servlo-card/60 border border-gray-100 dark:border-servlo-border px-3 py-3">
        <div class="flex items-center gap-2 mb-2">
          <span class="w-5 h-5 inline-flex items-center justify-center rounded-full bg-servlo-red/15 text-servlo-red text-[11px] font-semibold">1</span>
        ...
        <code class="block text-xs font-mono bg-gray-100 dark:bg-white/5 text-gray-700 dark:text-gray-300 rounded-sm px-2 py-1.5 overflow-x-auto">servlo park ~/Code</code>
      </div>

      <div class="rounded-lg bg-white/70 dark:bg-servlo-card/60 border border-gray-100 dark:border-servlo-border px-3 py-3 flex flex-col">
        <div class="flex items-center gap-2 mb-2">
          <span class="w-5 h-5 inline-flex items-center justify-center rounded-full bg-servlo-red/15 text-servlo-red text-[11px] font-semibold">2</span>
      ...
      <div class="rounded-lg bg-white/70 dark:bg-servlo-card/60 border border-gray-100 dark:border-servlo-border px-3 py-3 flex flex-col">
        <div class="flex items-center gap-2 mb-2">
          <span class="w-5 h-5 inline-flex items-center justify-center rounded-full bg-servlo-red/15 text-servlo-red text-[11px] font-semibold">3</span>
    ...
    <div class="mt-4 flex items-center gap-3 text-xs text-gray-500 dark:text-gray-400">
      <button
        type="button"
        onclick={openDocs}
        class="font-medium text-servlo-red hover:text-servlo-redhov transition-colors"
