<script lang="ts">
  ...
  // Edits the per-project Stripe webhook route (persisted to .servlo.yaml). Lets
...
<Modal {open} {onclose} title={m.sites_controls_stripeConfigTitle()} size="sm">
  <div class="px-5 py-4 space-y-3">
    ...
    <input
      ...
      class="w-full text-sm font-mono px-2.5 py-1.5 rounded-sm border border-gray-200 dark:border-servlo-border bg-white dark:bg-servlo-card text-gray-800 dark:text-gray-100 focus:outline-none focus:ring-1 focus:ring-servlo-red"
    />
